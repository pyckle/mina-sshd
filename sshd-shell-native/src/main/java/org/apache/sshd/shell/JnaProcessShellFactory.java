 ...
 */
public class JnaProcessShellFactory extends AbstractLoggingBean implements ShellFactory {

    public static final String JNA_FACTORY_NAME = "jna";

    private String command;
    private List<String> elements;

    public JnaProcessShellFactory() {
        this.command = OsUtils.resolveDefaultInteractiveShellCommand();
        this.elements = OsUtils.resolveDefaultInteractiveCommandElements();
    }
    ...
    public Command createShell(ChannelSession channel) {
        return new JnaProcessShell(resolveEffectiveCommand(channel, getCommand(), getElements()));
    }
