    ...
    public long transferTo(long position, long count, WritableByteChannel target) throws IOException {
        ...
        synchronized (lock) {
            try {
                ...
                SftpInputStreamAsync input = new SftpInputStreamAsync((AbstractSftpClient) sftp,
    ...
    public long transferFrom(ReadableByteChannel src, long position, long count) throws IOException {
        ...
        synchronized (lock) {
            try {
                ...
                SftpOutputStreamAsync output = new SftpOutputStreamAsync((AbstractSftpClient) sftp,
